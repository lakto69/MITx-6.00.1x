...
def test_isValidWord(wordList):
    ...
    if not isValidWord(word, handCopy, wordList):
        print("FAILURE: test_isValidWord() 1")
    ...
    if not isValidWord(word, handCopy, wordList):
        print("FAILURE: test_isValidWord() 2")
    ...
    if  isValidWord(word, hand, wordList):
        print("FAILURE: test_isValidWord() 3")
    ...
    if  not isValidWord(word, hand, wordList):
        print("FAILURE: test_isValidWord() 4")
    ...
    if  isValidWord(word, hand, wordList):
        print("FAILURE: test_isValidWord() 5")
        print("\tExpected False, but got True for word: '" + word + "' and hand:", hand)
    ...
    if  not isValidWord(word, hand, wordList):
        print("FAILURE: test_isValidWord() 6")
        print("\tExpected True, but got False for word: '" + word + "' and hand:", hand)
    ...
    if  isValidWord(word, hand, wordList):
        print("FAILURE: test_isValidWord() 7")
        print("\tExpected False, but got True for word: '" + word + "' and hand:", hand)
