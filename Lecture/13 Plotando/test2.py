...
plt.plot(mySamples, myQuadratic,'ro', label = 'quadrática')
plt.legend(loc = 'center left')
plt.title('Linear vs. Quadrática')
plt.figure('cube exp')
plt.clf()
plt.plot(mySamples, myCubic, 'g^', label = 'cubica')
plt.plot(mySamples, myExponential, 'r--',label = 'exponencial')
plt.legend()
plt.title('Cubica vs. Exponencial')
